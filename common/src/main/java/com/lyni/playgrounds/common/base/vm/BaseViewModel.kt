package com.lyni.playgrounds.common.base.vm
...
//    protected fun <T> net(call: suspend () -> MallResponse<T>) = flow {
//        netEmit(call.invoke())
//    }.flowCatch()
//
//    protected fun asyncLaunch(call: suspend () -> Unit) = viewModelScope.safeLaunch {
//        block = {
//            call.invoke()
//        }
//    }
