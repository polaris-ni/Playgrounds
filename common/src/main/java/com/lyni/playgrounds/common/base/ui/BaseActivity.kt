package com.lyni.playgrounds.common.base.ui
...
import com.lyni.playgrounds.common.base.entity.CustomHolder
import com.lyni.playgrounds.common.base.entity.DialogType
import com.lyni.playgrounds.common.base.interfaces.DialogHandler
import com.lyni.playgrounds.common.R
import com.lyni.playgrounds.common.base.config.ToolbarConfig
import com.lyni.playgrounds.common.base.config.ToolbarProvider
import com.lyni.playgrounds.common.base.vm.BaseViewModel
import com.lyni.playgrounds.common.databinding.CommonActivityRootBinding
import com.lyni.playgrounds.common.databinding.CommonLayoutCustomHolderBinding
...
abstract class BaseActivity<VB : ViewBinding, VM : BaseViewModel> : AppCompatActivity(),
    ...
    open fun initView() {
        ...
        toolbarConfig().backClick { super.onBackPressed() }
        // 沉浸式状态栏和导航栏
        immersiveStatusBar()
...
//                setEnableLoadMore(false)
    ...
    protected fun asyncLaunch(call: suspend () -> Unit) = lifecycleScope.safeLaunch(call)
